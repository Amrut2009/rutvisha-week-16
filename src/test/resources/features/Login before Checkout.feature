...
@sanity
  Scenario:  Login before Checkout
    ...
    And The user enters correct email address "rutvishaptel20@gmail.com"
    And The user enters correct password "rutu12345!"
    ...
    And The user enters payment details Name on Car"rutvishapatel"
